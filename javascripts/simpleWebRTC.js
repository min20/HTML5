	...
	return function(e, t, n) {
		...
		1: [
			function(e, t) {
				function n(e) {
					...
					this.capabilities = r, i.call(this), n = this.connection = c.connect(this.config.url, this.config.socketio), n.on("connect", function() {
						u.emit("connectionReady", n.socket.sessionid), u.sessionReady = !0,
							u.testReadiness()
					...
					}), e.logger = this.logger, e.debug = !1, this.webrtc = new o(e), [
						"mute", "unmute", "pauseVideo", "resumeVideo", "pause", "resume",
						"sendToAll", "sendDirectlyToAll"
					].forEach(function(e) {
		...
		4: [
			function(e, t) {
				...
				var s = window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
					...
					p = "https:" === window.location.protocol && (window.navigator.userAgent.match("Chrome") && parseInt(window.navigator.userAgent.match(/Chrome\/(.*) /)[1], 10) >= 26 || window.navigator.userAgent.match("Firefox") && parseInt(window.navigator.userAgent.match(/Firefox\/(.*)/)[1], 10) >= 33),
			...
			function(require, module, exports) {
				...
				! function() {
					if (function(e, t) {
						...
						var n = e.util = {},
							o = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
							i = ["source", "protocol", "authority", "userInfo", "user",
						...
						var n = e.parser = {},
							o = n.packets = ["disconnect", "connect", "heartbeat", "message",
									"json", "event", "ack", "error", "noop"
								],
							i = n.reasons = ["transport not supported", "client not handshaken",
									"unauthorized"
								],
						...
						e.Socket = o, t.util.mixin(o, t.EventEmitter), o.prototype.of = function(e) {
							...
							var o = this,
								r = this.options,
								s = ["http" + (r.secure ? "s" : "") + ":/", r.host + ":" + r.port,
											r.resource, t.protocol, t.util.query(this.options.query, "t=" + +new Date)
										].join("/");
							if (this.isXDomain() && !t.util.ua.hasCORS) {
								...
								u.open("GET", s, !0), this.isXDomain() && (u.withCredentials = !0),
							...
							return n.connecting = !0, this.handshake(function(o, i, r, s) {
								function a(e) {
									return n.transport && n.transport.clearTimeouts(), n.transport = n.getTransport(e), n.transport ? (n.transport.ready(n, function() {
										n.connecting = !0, n.publish("connecting", n.transport.name),
											n.transport.open(), n.options["connect timeout"] && (n.connectTimeoutTimer = setTimeout(function() {
							...
							function e() {
								...
								clearTimeout(n.reconnectionTimer), n.removeListener("connect_failed", t), n.removeListener("connect", t), n.reconnecting = !1, delete n.reconnectionAttempts, delete n.reconnectionDelay,
						...
						e.SocketNamespace = n, t.util.mixin(n, t.EventEmitter), n.prototype.$emit = t.EventEmitter.prototype.emit, n.prototype.of = function() {
							...
							return e.endpoint = this.name, this.socket.packet(e), this.flags = {},
								this
						...
						e.flashsocket = n, t.util.inherit(n, t.Transport.websocket), n.prototype.name = "flashsocket", n.prototype.open = function() {
							...
							function i() {
								var t = e.options,
									...
									s = ["http" + (t.secure ? "s" : "") + ":/", t.host + ":" + t.port,
												t.resource, "static/flashsocket", "WebSocketMain" + (e.isXDomain() ? "Insecure" : "") + ".swf"
											];
						...
						function n(e) {
							if (typeof L.addEventListener != O) L.addEventListener("load", e, !1);
							else if (typeof P.addEventListener != O) P.addEventListener("load", e, !1);
							else if (typeof L.attachEvent != O) g(L, "onload", e);
						...
						function i() {
							...
							if (n) {
								...
								! function() {
									...
									} else if (10 > o) return o++, setTimeout(arguments.callee, 10),
										void 0;
							...
							if (e > 0)
								for (var t = 0; e > t; t++) {
									...
									if (J.pv[0] > 0) {
										var r = m(n);
										if (r)
											if (!v(F[t].swfVersion) || J.wk && J.wk < 312)
												if (F[t].expressInstall && a()) {
													var p = {};
													p.data = F[t].expressInstall, p.width = r.getAttribute("width") || "0", p.height = r.getAttribute("height") || "0", r.getAttribute("class") && (p.styleclass = r.getAttribute("class")), r.getAttribute("align") && (p.align = r.getAttribute("align"));
						...
						function c(e, t, n, o) {
							...
							if (i) {
								"OBJECT" == i.nodeName ? (S = p(i), T = null) : (S = i, T = n),
									e.id = N, (typeof e.width == O || !/%$/.test(e.width) && parseInt(e.width, 10) < 310) && (e.width = "310"), (typeof e.height == O || !/%$/.test(e.height) && parseInt(e.height, 10) < 137) && (e.height = "137"), P.title = P.title.slice(0, 47) + " - Flash Player Installation";
								var r = J.ie && J.win ? ["Active"].concat("").join("X") : "PlugIn",
									s = "MMredirectURL=" + L.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + r + "&MMdoctitle=" + P.title;
						...
						function l(e, t, n) {
							...
							if (i)
								if (typeof e.id == O && (e.id = n), J.ie && J.win) {
									...
									i.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + r + ">" + a + "</object>", $[$.length] = e.id, o = m(e.id)
								} else {
									var u = y(A);
						...
						function v(e) {
							var t = J.pv,
								n = e.split(".");
							return n[0] = parseInt(n[0], 10), n[1] = parseInt(n[1], 10) || 0,
								n[2] = parseInt(n[2], 10) || 0, t[0] > n[0] || t[0] == n[0] && t[1] > n[1] || t[0] == n[0] && t[1] == n[1] && t[2] >= n[2] ? !0 : !1
						}
							...
							if (!J.ie || !J.mac) {
								...
								if (i) {
									...
									if (o && (E = null, _ = null), !E || _ != r) {
										var s = y("style");
										s.setAttribute("type", "text/css"), s.setAttribute("media", r),
											E = i.appendChild(s), J.ie && J.win && typeof P.styleSheets != O && P.styleSheets.length > 0 && (E = P.styleSheets[P.styleSheets.length - 1]), _ = r
									}
									J.ie && J.win ? E && typeof E.addRule == A && E.addRule(e, t) : E && typeof P.createTextNode != O && E.appendChild(P.createTextNode(e + " {" + t + "}"))
								}
							}
						}
						...
						var S, T, C, x, E, _, O = "undefined",
							...
							J = function() {
								var e = typeof P.getElementById != O && typeof P.getElementsByTagName != O && typeof P.createElement != O,
									...
									a = [0, 0, 0],
									c = null;
								if (typeof M.plugins != O && typeof M.plugins[j] == A) c = M.plugins[j].description, !c || typeof M.mimeTypes != O && M.mimeTypes[R] && !M.mimeTypes[R].enabledPlugin || (W = !0, s = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), a[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), a[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), a[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
								else if (typeof L[["Active"].concat("Object").join("X")] != O) try {
						...
						return function() {
								J.w3 && ((typeof P.readyState != O && "complete" == P.readyState || typeof P.readyState == O && (P.getElementsByTagName("body")[0] || P.body)) && e(), X || (typeof P.addEventListener != O && P.addEventListener("DOMContentLoaded", e, !1), J.ie && J.win && (P.attachEvent(I, function() {
									...
									return X ? void 0 : /loaded|complete/.test(P.readyState) ? (e(), void 0) : (setTimeout(arguments.callee, 0), void 0)
								}(), n(e)))
							}(),
							function() {
								J.ie && J.win && window.attachEvent("onunload", function() {
									for (var e = B.length, t = 0; e > t; t++) B[t][0].detachEvent(B[t][1], B[t][2]);
									for (var n = $.length, o = 0; n > o; o++) f($[o]);
								...
								registerObject: function(e, t, n, o) {
									if (J.w3 && e && t) {
										var i = {};
										i.id = e, i.swfVersion = t, i.expressInstall = n, i.callbackFn = o, F[F.length] = i, w(e, !1)
									} else o && o({
										success: !1,
										id: e
									})
					...
					! function() {
						if ("undefined" != typeof window && !window.WebSocket) {
							...
							"file:" == location.protocol && e.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."), WebSocket = function(e, t, n, o, i) {
									var r = this;
									r.__id = WebSocket.__nextId++, WebSocket.__instances[r.__id] = r,
										r.readyState = WebSocket.CONNECTING, r.bufferedAmount = 0, r.__events = {},
										t ? "string" == typeof t && (t = [t]) : t = [], setTimeout(function() {
								...
								WebSocket.__tasks = [], WebSocket.__nextId = 0, WebSocket.loadFlashPolicyFile = function(e) {
									...
									if (!WebSocket.__flash) {
										if (WebSocket.__swfLocation && (window.WEB_SOCKET_SWF_LOCATION = WebSocket.__swfLocation), !window.WEB_SOCKET_SWF_LOCATION) return
										e.error("[WebSocket] set WEB_SOCKET_SWF_LOCATION to location of WebSocketMain.swf"), void 0;
										var t = document.createElement("div");
										t.id = "webSocketContainer", t.style.position = "absolute",
									...
									setTimeout(function() {
										WebSocket.__flash = document.getElementById("webSocketFlash"),
											WebSocket.__flash.setCallerUrl(location.href), WebSocket.__flash.setDebug(!!window.WEB_SOCKET_DEBUG);
					...
					function(e, t, n) {
						...
						e.XHR = o, t.util.inherit(o, t.Transport), o.prototype.open = function() {
							...
							var r = this;
							this.socket.setBuffer(!0), this.sendXHR = this.request("POST"), n.XDomainRequest && this.sendXHR instanceof XDomainRequest ? this.sendXHR.onload = this.sendXHR.onerror = o : this.sendXHR.onreadystatechange = t,
								this.sendXHR.send(e)
						}, o.prototype.close = function() {
					...
					function(e, t) {
						...
						e.htmlfile = n, t.util.inherit(n, t.Transport.XHR), n.prototype.name = "htmlfile", n.prototype.get = function() {
							this.doc = new(window[["Active"].concat("Object").join("X")])("htmlfile"), this.doc.open(), this.doc.write("<html></html>"),
								this.doc.close(), this.doc.parentWindow.s = this;
							...
							if (this.iframe) {
								...
								this.doc = null, this.iframe.parentNode.removeChild(this.iframe),
									this.iframe = null, CollectGarbage()
							}
						}, n.prototype.close = function() {
					...
					function(e, t, n) {
						...
						e["jsonp-polling"] = o, t.util.inherit(o, t.Transport["xhr-polling"]),
							o.prototype.name = "jsonp-polling", o.prototype.post = function(e) {
								function n() {
								...
								if (!this.form) {
									...
									a.className = "socketio", a.style.position = "absolute", a.style.top = "0px", a.style.left = "0px", a.style.display = "none", a.target = u, a.method = "POST", a.setAttribute("accept-charset", "utf-8"),
										c.name = "d", a.appendChild(c), document.body.appendChild(a),
										this.form = a, this.area = c
								}
								...
								this.script && (this.script.parentNode.removeChild(this.script), this.script = null), n.async = !0, n.src = this.prepareUrl() + o,
									n.onerror = function() {
										e.onClose()
									};
		...
		9: [
			function(e, t, n) {
				...
				r.prototype.setMaxListeners = function(e) {
					...
					if (s(t)) {
						for (var n = Array.prototype.slice.call(arguments, 1), o = t.slice(),
							i = 0, r = o.length; r > i; i++) o[i].apply(this, n);
						return !0
					}
					return !1
					...
					return this._events || (this._events = {}), this._events[e] || (this._events[e] = []), s(this._events[e]) || (this._events[e] = [this._events[e]]),
						this._events[e]
		...
		10: [
			function(e, t) {
				function n(e) {
					var t = this;
					this.id = e.id, this.parent = e.parent, this.type = e.type || "video",
						this.oneway = e.oneway || !1, this.sharemyscreen = e.sharemyscreen || !1, this.browserPrefix = e.prefix, this.stream = e.stream, this.enableDataChannels = void 0 === e.enableDataChannels ? this.parent.config.enableDataChannels : e.enableDataChannels, this.receiveMedia = e.receiveMedia || this.parent.config.receiveMedia, this.channels = {}, this.pc = new r(this.parent.config.peerConnectionConfig, this.parent.config.peerConnectionConstraints), this.pc.on("ice", this.onIceCandidate.bind(this)), this.pc.on("addStream", this.handleRemoteStreamAdded.bind(this)), this.pc.on("addChannel", this.handleDataChannelAdded.bind(this)), this.pc.on("removeStream", this.handleStreamRemoved.bind(this)), this.pc.on("negotiationNeeded", this.emit.bind(this, "negotiationNeeded")),
						this.pc.on("iceConnectionStateChange", this.emit.bind(this, "iceConnectionStateChange")), this.pc.on("iceConnectionStateChange", function() {
		...
		11: [
			function(e, t) {
				function n(e) {
					...
					this.logger = n.logger, this._log = this.logger.log.bind(this.logger, "LocalMedia:"), this._logerror = this.logger.error.bind(this.logger, "LocalMedia:"), this.screenSharingSupport = r.screenSharing, this.localStreams = [],
						this.localScreens = [], r.support || this._logerror("Your browser does not support local media capture.")
				}
				var o = e("util"),
					i = e("hark"),
					r = e("webrtcsupport"),
			...
			function(e, t, n) {
				! function() {
					...
					x.contains = x.include = function(e, t) {
						...
						if (!t && x.isArray(e) && e[0] === +e[0] && e.length < 65535) return
					...
					x.sortBy = function(e, t, n) {
						return t = A(t), x.pluck(x.map(e, function(e, o, i) {
							return {
								value: e,
								index: o,
					...
					var j = function(e) {
						return function(t, n, o) {
							var i = {};
							return n = A(n), E(t, function(r, s) {
								var a = n.call(o, r, s, t);
								e(i, a, r)
							}), i
						}
					};
					x.groupBy = j(function(e, t, n) {
						x.has(e, t) ? e[t].push(n) : e[t] = [n]
					}), x.indexBy = j(function(e, t, n) {
						e[t] = n
					}), x.countBy = j(function(e, t) {
						x.has(e, t) ? e[t] ++ : e[t] = 1
					...
					x.each(["escape", "unescape"], function(e) {
						...
						E(x.functions(e), function(t) {
							...
							x.prototype[t] = function() {
								var e = [this._wrapped];
								return c.apply(e, arguments), F.call(this, n.apply(x, e))
							}
						})
					};
					var P = 0;
					...
					x.mixin(x), E(["pop", "push", "reverse", "shift", "sort", "splice",
						"unshift"
					], function(e) {
						var t = r[e];
			...
			function(e, t) {
				function n(e) {
					if (this.support = o.webAudio && o.mediaStream, this.gain = 1, this.support) {
						...
						this.microphone = t.createMediaStreamSource(e), this.gainFilter = t.createGain(),
							this.destination = t.createMediaStreamDestination(), this.outputStream = this.destination.stream, this.microphone.connect(this.gainFilter),
							this.gainFilter.connect(this.destination), e.addTrack(this.outputStream.getAudioTracks()[0]), e.removeTrack(e.getAudioTracks()[0])
					}
					this.stream = e
				}
		...
		13: [
			function(e, t) {
				function n(e, t) {
					var n, o = this;
					a.call(this), e = e || {}, e.iceServers = e.iceServers || [], this.pc = new c(e, t), this.getLocalStreams = this.pc.getLocalStreams.bind(this.pc), this.getRemoteStreams = this.pc.getRemoteStreams.bind(this.pc), this.addStream = this.pc.addStream.bind(this.pc), this.removeStream = this.pc.removeStream.bind(this.pc), this.pc.on("*", function() {
							o.emit.apply(o, arguments)
						}), this.pc.onremovestream = this.emit.bind(this, "removeStream"),
						this.pc.onnegotiationneeded = this.emit.bind(this, "negotiationNeeded"), this.pc.oniceconnectionstatechange = this.emit.bind(this, "iceConnectionStateChange"), this.pc.onsignalingstatechange = this.emit.bind(this, "signalingStateChange"), this.pc.onaddstream = this._onAddStream.bind(this), this.pc.onicecandidate = this._onIce.bind(this), this.pc.ondatachannel = this._onDataChannel.bind(this), this.localDescription = {
							contents: []
					...
					}), this.hadLocalStunCandidate = !1, this.hadRemoteStunCandidate = !1, this.hadLocalRelayCandidate = !1, this.hadRemoteRelayCandidate = !1, this._remoteDataChannels = [], this._localDataChannels = []
				}
				var o = e("underscore"),
					i = e("util"),
					r = e("webrtcsupport"),
				...
				i.inherits(n, a), Object.defineProperty(n.prototype, "signalingState", {
					...
					} else 0 !== e.candidate.candidate.indexOf("a=") && (e.candidate.candidate = "a=" + e.candidate.candidate), n.pc.addIceCandidate(new r.IceCandidate(e.candidate)), -1 !== e.candidate.candidate.indexOf("typ srflx") ? n.hadRemoteStunCandidate = !0 : -1 !== e.candidate.candidate.indexOf("typ relay") && (n.hadRemoteRelayCandidate = !0);
					t()
				...
				t.exports = function(e, t) {
					...
					if (window.navigator.userAgent.match("Chrome")) {
						...
						p >= 33 ? (e = r && e || {
							...
							if (s(e, t), !e) var n = t.currentTime,
			...
			function(e, t, n) {
				...
				n.toSessionSDP = function(e, t, o) {
					...
					var t = [],
						...
						a = r && r.fingerprints || [],
						c = [];
					if ("datachannel" == i.descType ? (c.push("application"), c.push("1"), c.push("DTLS/SCTP"), r.sctp && r.sctp.forEach(function(e) {
						c.push(e.number)
						...
						c.push(e.id)
					})), t.push("m=" + c.join(" ")), t.push("c=IN IP4 0.0.0.0"), "rtp" == i.descType && t.push("a=rtcp:1 IN IP4 0.0.0.0"), r) {
						r.ufrag && t.push("a=ice-ufrag:" + r.ufrag), r.pwd && t.push("a=ice-pwd:" + r.pwd);
						var u = !1;
						a.forEach(function(e) {
							t.push("a=fingerprint:" + e.hash + " " + e.value), e.setup && !u && t.push("a=setup:" + e.setup)
					...
					var t = [];
					t.push(e.foundation), t.push(e.component), t.push(e.protocol.toUpperCase()),
						t.push(e.priority), t.push(e.ip), t.push(e.port);
					var n = e.type;
					return t.push("typ"), t.push(n), ("srflx" === n || "prflx" === n || "relay" === n) && e.relAddr && e.relPort && (t.push("raddr"), t.push(e.relAddr), t.push("rport"), t.push(e.relPort)), e.tcpType && (t.push("tcptype"), t.push(e.tcpType)), t.push("generation"), t.push(e.generation || "0"), "a=candidate:" + t.join(" ")
				}
			}, {}
		],
		24: [
			...
			function(e, t, n) {
				...
				n._setIdCounter = function(e) {
					...
					var b = o.findLines("a=fingerprint:", r, s),
						w = o.findLine("a=setup:", r, s);
					b.forEach(function(e) {
						var t = o.fingerprint(e);
						w && (t.setup = w.substr(8)), p.fingerprints.push(t)
					});
					var k = o.findLine("a=ice-ufrag:", r, s),
						S = o.findLine("a=ice-pwd:", r, s);
					if (k && S) {
						p.ufrag = k.substr(12), p.pwd = S.substr(10), p.candidates = [];
						var T = o.findLines("a=candidate:", r, s);
						T.forEach(function(e) {
							p.candidates.push(n.toCandidateJSON(e))
						})
					}
					if ("datachannel" == u.descType) {
						var C = o.findLines("a=sctpmap:", r);
		...
		15: [
			function(e, t) {
				...
				t.exports = function(e, t) {
					...
					r || (r = new i);
					var f, d, m;
					m = r.createAnalyser(), m.fftSize = 512, m.smoothingTimeConstant = a,
						d = new Float32Array(m.fftSize), e.jquery && (e = e[0]), e instanceof HTMLAudioElement || e instanceof HTMLVideoElement ? (f = r.createMediaElementSource(e), "undefined" == typeof p && (p = !0), u = u || -50) : (f = r.createMediaStreamSource(e), u = u || -50), f.connect(m), p && m.connect(r.destination), s.speaking = !1, s.setThreshold = function(e) {
							u = e
					...
					var g = function() {
						setTimeout(function() {
							if (h) {
								...
								s.speakingHistory.shift(), s.speakingHistory.push(0 + (e > u)),
									g()
							}
						}, c)
					};
			...
			function(e, t, n) {
				n.lines = function(e) {
					...
					for (var t, n, o, i = e.substr(e.indexOf(" ") + 1).split(";"), r = [],
						s = 0; s < i.length; s++) t = i[s].split("="), n = t[0].trim(), o = t[1], n && o ? r.push({
						key: n,
						value: o
					}) : n && r.push({
						key: "",
					...
					var t = e.substr(10).split(" "),
						n = {};
					return n.id = t.shift(), n.type = t.shift(), "trr-int" === n.type ? n.value = t.shift() : n.subtype = t.shift() || "", n.parameters = t,
						n
...
! function() {
	! function(e, t) {
		var n = e;
		n.version = "0.9.16", n.protocol = 1, n.transports = [], n.j = [], n.sockets = {},
	...
	function(e, t) {
		var n = e.util = {},
			o = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
			i = ["source", "protocol", "authority", "userInfo", "user", "password",
	...
	function(e, t) {
		var n = e.parser = {},
			o = n.packets = ["disconnect", "connect", "heartbeat", "message", "json",
	...
	function(e, t, n) {
		...
		e.Socket = o, t.util.mixin(o, t.EventEmitter), o.prototype.of = function(e) {
			...
			var o = this,
				r = this.options,
				s = ["http" + (r.secure ? "s" : "") + ":/", r.host + ":" + r.port, r.resource,
					t.protocol, t.util.query(this.options.query, "t=" + +new Date)
				].join("/");
			if (this.isXDomain() && !t.util.ua.hasCORS) {
				var a = document.getElementsByTagName("script")[0],
					c = document.createElement("script");
			...
			return n.connecting = !0, this.handshake(function(o, i, r, s) {
				...
				n.sessionid = o, n.closeTimeout = 1e3 * r, n.heartbeatTimeout = 1e3 * i,
					n.transports || (n.transports = n.origTransports = s ? t.util.intersect(s.split(","), n.options.transports) : n.options.transports), n.setHeartbeatTimeout(),
					a(n.transports), n.once("connect", function() {
						clearTimeout(n.connectTimeoutTimer), e && "function" == typeof e && e()
					})
			}), this
		}, o.prototype.setHeartbeatTimeout = function() {
			...
			var e = t.util.request(),
				n = ["http" + (this.options.secure ? "s" : "") + ":/", this.options.host +
					":" + this.options.port, this.options.resource, t.protocol, "", this.sessionid
				].join("/") + "/?disconnect=1";
			e.open("GET", n, !1), e.send(null), this.onDisconnect("booted")
		}, o.prototype.isXDomain = function() {
			var e = n.location.port || ("https:" == n.location.protocol ? 443 : 80);
			...
			function e() {
				...
				clearTimeout(n.reconnectionTimer), n.removeListener("connect_failed", t),
					n.removeListener("connect", t), n.reconnecting = !1, delete n.reconnectionAttempts,
					delete n.reconnectionDelay, delete n.reconnectionTimer, delete n.redoTransports,
	...
	function(e, t) {
		...
		e.htmlfile = n, t.util.inherit(n, t.Transport.XHR), n.prototype.name = "htmlfile", n.prototype.get = function() {
			this.doc = new(window[["Active"].concat("Object").join("X")])("htmlfile"),
				this.doc.open(), this.doc.write("<html></html>"), this.doc.close(), this.doc.parentWindow.s = this;
			var e = this.doc.createElement("div");
			e.className = "socketio", this.doc.body.appendChild(e), this.iframe = this.doc.createElement("iframe"), e.appendChild(this.iframe);
			var n = this,
				o = t.util.query(this.socket.options.query, "t=" + +new Date);
	...
	function(e, t, n) {
		...
		e["xhr-polling"] = o, t.util.inherit(o, t.Transport.XHR), t.util.merge(o, t.Transport.XHR), o.prototype.name = "xhr-polling", o.prototype.heartbeats = function() {
			...
			function t() {
				this.onload = i, this.onerror = i, r.retryCounter = 1, r.onData(this.responseText),
					r.get()
			}
